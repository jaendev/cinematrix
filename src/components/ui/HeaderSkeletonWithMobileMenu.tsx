export function HeaderSkeletonWithMobileMenu() {
  return (
      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="md:hidden mt-4 pb-4 border-t border-gray-800 pt-4">
          <div className="space-y-4">
            ...
            <div className="relative">
              <div className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 bg-gray-600 rounded animate-pulse"></div>
              <div className="bg-gray-800 border border-gray-700 rounded-lg h-10 w-full animate-pulse"></div>
            </div>

            {/* Mobile Auth Button Skeleton */}
            <div className="w-full bg-yellow-400/30 rounded-lg h-10 animate-pulse"></div>
          </div>
        </div>
      </div>
    </header>
