      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-800 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-yellow-400/20 to-yellow-500/20 p-8 text-center">
            ...
            <div className="h-7 w-32 bg-gray-700 rounded mx-auto mb-2 animate-pulse"></div>
          ...
          <div className="p-8 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <div className="w-full h-12 bg-gray-800 rounded-lg border border-gray-700 animate-pulse"></div>
              </div>
            </div>
            ...
            {/* Date of Birth Skeleton (CustomDatePicker style) */}
            <div>
              <div className="flex items-center space-x-2 mb-2">
                <div className="h-4 w-24 bg-gray-700 rounded animate-pulse"></div>
                <div className="h-3 w-16 bg-gray-600 rounded animate-pulse"></div>
              ...
              <div className="relative">
                <div className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 bg-gray-600 rounded animate-pulse z-10"></div>
                <div className="w-full h-12 bg-gray-800 rounded-lg border border-gray-700 animate-pulse"></div>
              </div>
            </div>
            ...
            <div className="mt-8 text-center">
              <div className="flex items-center justify-center space-x-1">
                ...
                <div className="h-4 w-16 bg-yellow-600/50 rounded animate-pulse"></div>
              </div>
            </div>
          </div>
        </div>
